...
combines compile-time Dagger assembly, generated wiring, phased lifecycle, and typed configuration
with composable HTTP, event-bus services, persistence, durable work, security, Kafka, management,
and observability.
