...
| `com.google.dagger:dagger` | 2.59.2 | Apache-2.0 | Compile-time DI, incl. `dagger-compiler` annotation processor |
| `com.fasterxml.jackson:jackson-bom` | 2.21.4 | Apache-2.0 | |
| `io.micrometer:micrometer-bom` | 1.16.6 | Apache-2.0 | |
| `io.opentelemetry:opentelemetry-bom` | 1.63.0 | Apache-2.0 | |
| `io.opentelemetry.semconv:opentelemetry-semconv` | 1.41.1 | Apache-2.0 | |
| `io.prometheus:prometheus-metrics-bom` | 1.4.3 | Apache-2.0 | |
...
| `ch.qos.logback:logback-classic` / `logback-core` | 1.5.34 | EPL-1.0 OR LGPL-2.1 | Recipient's choice |
...
| `io.apicurio:apicurio-registry-avro-serde-kafka` | 3.2.4 | Apache-2.0 | |
...
| `dev.cel:cel` | 0.12.0 | Apache-2.0 | Isolated to `vertique-workflow-definition` |
| `io.github.jopenlibs:vault-java-driver` | 6.2.2 | MIT | Isolated to `vertique-config-vault` |
| `software.amazon.awssdk:bom` | 2.48.3 | Apache-2.0 | Isolated to `vertique-config-aws-*` |
...
| `com.palantir.javapoet:javapoet` | 0.14.0 | Apache-2.0 | Codegen source generation |
...
| `org.mockito:mockito-core` / `mockito-junit-jupiter` | 5.22.0 | MIT |
...
| `org.apache.maven.plugins:maven-dependency-plugin` | 3.7.0 | Apache-2.0 |
| `org.apache.maven.plugins:maven-surefire-plugin` / `maven-failsafe-plugin` | 3.5.5 | Apache-2.0 |
...
| `org.codehaus.mojo:exec-maven-plugin` | 3.0.0 | Apache-2.0 |
| `com.google.cloud.tools:jib-maven-plugin` | 3.5.1 | Apache-2.0 |
| `com.diffplug.spotless:spotless-maven-plugin` | 3.3.0 | Apache-2.0 |
| `org.jacoco:jacoco-maven-plugin` | 0.8.12 | EPL-2.0 |
| `org.codehaus.mojo:flatten-maven-plugin` | 1.7.0 | Apache-2.0 |
