 ...
 * {@code maxFailures >= 1}, {@code timeoutMs > 0}, and {@code resetTimeoutMs > 0}.
 *
 ...
 */
public record RestClientCircuitBreakerConfig(Integer maxFailures, Long timeoutMs, Long resetTimeoutMs) {
