...
/**
 * Hand-written module contributing {@link ManualResource} one instance at a time via
...
public final class ManualResourceModule {
    ...
    /**
     * Contributes the Dagger-constructed {@link ManualResource} into the
    ...
    @IntoSet
    @JaxRsResources
    static Object manualResource(ManualResource r) {
        return r;
    }
}
