 ...
 * accessor to the {@code dev.vertique.rest.jaxrs.application} test package, which cannot reach a
 * package-private member declared in this (different) test package. Calls only
 * {@link JaxRsRouterMount#orderedResources()} — no other access.
 */
