...
| [`dev.vertique:vertique-archetype-services`](vertique-archetype-services/README.md) | A Vertique contract-based services application on `vertique-starter-services` |
