# Developing Vertique Cache Caffeine

> **Audience:** Vertique framework contributors and source agents
> **Public contract:** `vertique-cache-caffeine/src/main/resources/META-INF/vertique/module.md`

This module is the ownership boundary for the Caffeine cache provider. Its implementation may choose local storage details, but its integration surface remains the provider-neutral cache core.

## Source Map

- `dev.vertique.cache.caffeine` — Caffeine provider package root.
...
```text
./mvnw -ntp -pl vertique-cache/vertique-cache-caffeine -am test
```
