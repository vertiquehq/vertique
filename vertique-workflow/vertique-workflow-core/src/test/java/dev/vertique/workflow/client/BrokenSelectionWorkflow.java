...
/**
 * Workflow contract fixture whose generated proxy companion
 * ({@code BrokenSelectionWorkflow_WorkflowClientProxy}) throws on construction, verifying that
 ...
 * degrading to the JDK proxy.
 *
 * <p>Targets the {@code selection-saga-broken} definition (v1).
 */
@WorkflowContract(definitionId = "selection-saga-broken", definitionVersion = 1)
interface BrokenSelectionWorkflow {

    /**
     * Starts a broken-selection workflow instance.
     *
