 ...
 * member ({@link TestNestedAnnotationAttr#nested()}) on an intercepted method compiles through the
 * recursive literal emitter.
 *
 ...
 */
class NestedAnnotationMemberCompilesTest {

    /**
     * A single-{@code @Inject}-ctor bean whose intercepted method carries an aspect trigger
     * ({@link TestTimed}) plus a runtime-retained annotation ({@link TestNestedAnnotationAttr}) with
     * a nested-annotation member.
     */
