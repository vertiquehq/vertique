 ...
 * {@code DispatchEnvelope<?>} params and multiple payload params; this validator checks the pre-extracted
 * {@link ContractModel} for any residual violations to satisfy the pipeline contract.
 *
