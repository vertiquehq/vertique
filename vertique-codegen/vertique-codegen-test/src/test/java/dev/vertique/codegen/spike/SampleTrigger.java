 ...
 *
 * <p>It deliberately covers the three attribute kinds a generated {@code Xxx$Literal} must support to
 * be a representative proof: a {@code String} member, a primitive ({@code int}) member, and a
