...
/**
 * Thrown when a delayed-job operation fails because of a persistence-layer error.
 *
 * <p>This is the delayed-job-domain projection of a database failure that crossed the delayed-job
 * API boundary. The {@link DelayedJobExceptionMapper} translates
 * {@link dev.vertique.db.exception.DataAccessException} subtypes into this exception so that
 * callers of the delayed-job API see delayed-job exceptions, not data-access exceptions.
 *
 ...
 */
public class DelayedJobPersistenceException extends DelayedJobTechnicalException {

    private final boolean retryable;

    /**
     * Creates a new {@code DelayedJobPersistenceException}.
     *
     ...
     */
    public DelayedJobPersistenceException(String message, Throwable cause, boolean retryable) {
        super(message, cause);
