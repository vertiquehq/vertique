...
class PromotedFieldRoutingTest {
    ...
    /** Projection that promotes the given keys onto one owner, as unwrapping does. */
    ...
    void promotedKeyReceivesTheDeclaringTypesPolicies() {
        InputFieldNameResolver resolver = promoting(
                ...
                Map.of(
                        "street", new PromotedField(Address.class, "street"),
                        "city", new PromotedField(Address.class, "city")));
    ...
    void promotedKeyKeepsItsWireKey() {
        InputFieldNameResolver resolver =
                promoting(UnwrappedOwner.class, Map.of("street", new PromotedField(Address.class, "street")));
    ...
    void promotedKeyWithNoPolicyIsUntouched() {
        InputFieldNameResolver resolver =
                promoting(PlainOwner.class, Map.of("value", new PromotedField(Plain.class, "value")));
    ...
    void promotedPolicyUnderAGeneratedProcessorFailsRegistration() {
        InputFieldNameResolver resolver =
                promoting(ProjectedDto.class, Map.of("street", new PromotedField(Address.class, "street")));
    ...
    void promotedFieldWithoutPolicyUnderAGeneratedProcessorIsAccepted() {
        InputFieldNameResolver resolver =
                promoting(ProjectedDto.class, Map.of("value", new PromotedField(Plain.class, "value")));
