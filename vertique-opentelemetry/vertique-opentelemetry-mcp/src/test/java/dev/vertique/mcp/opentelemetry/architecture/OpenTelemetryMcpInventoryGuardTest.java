...
class OpenTelemetryMcpInventoryGuardTest {
    ...
    void shouldExportOnlyRecordedGenericSignatures() {
        ...
        Set<String> recordedTypes = OpenTelemetryMcpInventoryChecker.recordedTypes(recorded);
        ...
        assertThat(unrecordedTypes)
                .as("public types exported by vertique-opentelemetry-mcp but absent from " + INVENTORY_RESOURCE)
                .isEmpty();
        assertThat(unimplementedTypes)
                .as("recorded public types no longer exported by vertique-opentelemetry-mcp")
                .isEmpty();
